...
public class AWSGlueDecoratorBase implements AWSGlue {
    ...
    @Override
    public BatchGetCustomEntityTypesResult batchGetCustomEntityTypes(
    ...
    @Override
    public BatchGetDataQualityResultResult batchGetDataQualityResult(
    ...
    @Override
    public CancelDataQualityRuleRecommendationRunResult cancelDataQualityRuleRecommendationRun(
    ...
    @Override
    public CreateCustomEntityTypeResult createCustomEntityType(
    ...
    @Override
    public CreateDataQualityRulesetResult createDataQualityRuleset(
    ...
    @Override
    public DeleteCustomEntityTypeResult deleteCustomEntityType(
    ...
    @Override
    public DeleteDataQualityRulesetResult deleteDataQualityRuleset(
    ...
    @Override
    public GetDataQualityRuleRecommendationRunResult getDataQualityRuleRecommendationRun(
    ...
    @Override
    public GetDataQualityRulesetResult getDataQualityRuleset(
    ...
    @Override
    public GetDataQualityRulesetEvaluationRunResult getDataQualityRulesetEvaluationRun(
    ...
    @Override
    public ListCustomEntityTypesResult listCustomEntityTypes(
    ...
    @Override
    public ListDataQualityResultsResult listDataQualityResults(
    ...
    @Override
    public ListDataQualityRuleRecommendationRunsResult listDataQualityRuleRecommendationRuns(
    ...
    @Override
    public ListDataQualityRulesetEvaluationRunsResult listDataQualityRulesetEvaluationRuns(
    ...
    @Override
    public ListDataQualityRulesetsResult listDataQualityRulesets(
    ...
    @Override
    public StartDataQualityRuleRecommendationRunResult startDataQualityRuleRecommendationRun(
    ...
    @Override
    public StartDataQualityRulesetEvaluationRunResult startDataQualityRulesetEvaluationRun(
    ...
    @Override
    public UpdateDataQualityRulesetResult updateDataQualityRuleset(
    ...
    @Override
    public UpdateJobFromSourceControlResult updateJobFromSourceControl(
    ...
    @Override
    public UpdateSourceControlFromJobResult updateSourceControlFromJob(
